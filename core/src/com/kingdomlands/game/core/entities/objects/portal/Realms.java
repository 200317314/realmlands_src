...
public enum Realms {
    ...
    WETLANDS(new Image(new Texture(Gdx.files.internal("portal/wetlands_icon.png"))), "Wet Lands",
            5 , "A wet land full of strong monsters to try and ambush you.", new Group[]{Group.SCORPION_PIT}, Stages.ADVENTURE_MAP),
    UNDEADLANDS(new Image(new Texture(Gdx.files.internal("portal/undeadlands_icon.png"))), "Undead Forest",
            10 , "A haunted forest filled with enchanted souls who died years ago.", new Group[]{}, Stages.ADVENTURE_MAP);
